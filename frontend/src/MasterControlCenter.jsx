...
const defaultRolePermissions = {
  ...
  nps_operator: ['home', 'nps_management', 'nps_dashboard', 'whatsapp_management', 'whatsapp_dashboard', 'whatsapp_send', 'whatsapp_templates', 'whatsapp_history', 'whatsapp_reports'],
  partner: ['home'],
...
const authorityRules = [
  ...
  { area: 'NPS', action: 'Gerir registros NPS', permission: 'nps_management', roles: ['master_admin', 'admin', 'supervisor_crc', 'sac_operator', 'nps_operator', 'manager', 'coordinator', 'viewer'], note: 'Controle principal por permissao de tela.' },
  ...
  { area: 'WhatsApp CRC', action: 'Acessar central WhatsApp', permission: 'whatsapp_management', roles: ['master_admin', 'admin', 'supervisor_crc', 'sac_operator', 'crc_leader', 'crc_manager', 'crc_operator', 'nps_operator'], note: 'Central operacional, cadastro de números, mensagens, chatbot e relatórios.' },
...
const routeControls = [
  ...
  { area: 'WhatsApp CRC', type: 'Caminho', title: 'Gestao WhatsApp CRC', path: '/home/whatsapp-management/dashboard', permission: 'whatsapp_management', roles: ['master_admin', 'admin', 'supervisor_crc', 'sac_operator', 'crc_leader', 'crc_manager', 'crc_operator', 'nps_operator'], note: 'Central de atendimento, envio, chatbot e relatorios.' },
  { area: 'WhatsApp CRC', type: 'Caminho', title: 'Dashboard WhatsApp', path: '/home/whatsapp-management/dashboard', permission: 'whatsapp_dashboard', roles: ['master_admin', 'admin', 'supervisor_crc', 'crc_leader', 'crc_manager', 'nps_operator'], note: 'Métricas por operador, clínica, número e fila.' },
  ...
  { area: 'WhatsApp CRC', type: 'Caminho', title: 'Envio manual WhatsApp', path: '/home/whatsapp-management/send', permission: 'whatsapp_send', roles: ['master_admin', 'admin', 'supervisor_crc', 'crc_leader', 'crc_manager', 'crc_operator', 'nps_operator'], note: 'Disparo individual com histórico.' },
  { area: 'WhatsApp CRC', type: 'Caminho', title: 'Mensagens padrão', path: '/home/whatsapp-management/templates', permission: 'whatsapp_templates', roles: ['master_admin', 'admin', 'supervisor_crc', 'crc_leader', 'crc_manager', 'crc_operator', 'nps_operator'], note: 'Biblioteca de textos operacionais.' },
  ...
  { area: 'WhatsApp CRC', type: 'Caminho', title: 'Histórico WhatsApp', path: '/home/whatsapp-management/history', permission: 'whatsapp_history', roles: ['master_admin', 'admin', 'supervisor_crc', 'crc_leader', 'crc_manager', 'crc_operator', 'nps_operator'], note: 'Auditoria de mensagens.' },
  { area: 'WhatsApp CRC', type: 'Caminho', title: 'Relatórios WhatsApp', path: '/home/whatsapp-management/reports', permission: 'whatsapp_reports', roles: ['master_admin', 'admin', 'supervisor_crc', 'crc_leader', 'crc_manager', 'nps_operator'], note: 'Exportações e indicadores.' },
